...
-- Q.1 Who receieved a 1.5kg package? The result is "Al Gore's Head".
SELECT client.name,package.weight from client 
inner join package on
client.accountnumber=package.recipient
having package.weight=1.5;

-- Q.2  What is the total weight of all the packages that he sent?
select sum(package.weight) from package 
inner join client on
client.accountnumber=package.recipient
and client.name="Al Gore's Head";